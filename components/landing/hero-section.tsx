    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto flex flex-col items-center mt-20">
        ...
        <motion.div
          ...
          className="overflow-x-auto mb-12 w-full flex justify-center"
        >
          <p className="text-muted-foreground text-lg md:text-xl lg:text-2xl uppercase tracking-widest whitespace-nowrap">
            {t.landing.subtitle}
          </p>
        </motion.div>
